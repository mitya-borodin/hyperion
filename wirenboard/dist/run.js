...
const run = async () => {
    const ls = (0, node_child_process_1.spawn)("DEBUG=BUTLER-WB-NET,BUTLER-WB-GSM,BUTLER-WB-ROUTE,BUTLER-WB-PING,BUTLER-WB-IFUP /root/node/bin/node", [(0, node_path_1.resolve)(__dirname, "index.js")]);
