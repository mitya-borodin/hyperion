export enum AC_DETECTOR {
  /**
   * Наличие напряжения на 1 фазе
   */
  AC_DETECTOR_1 = "AC_DETECTOR_1",

  /**
   * Наличие напряжения на 2 фазе
   */
  AC_DETECTOR_2 = "AC_DETECTOR_2",

  /**
   * Наличие напряжения на 3 фазе
   */
  AC_DETECTOR_3 = "AC_DETECTOR_3",

  /**
   * Напряжение на сигнале генератора
   */
  AC_DETECTOR_4 = "AC_DETECTOR_4",

  /**
   * Наличие напряжения на 1 фазе после АВР
   */
  AC_DETECTOR_5 = "AC_DETECTOR_5",

  /**
   * Наличие напряжения на 2 фазе после АВР
   */
  AC_DETECTOR_6 = "AC_DETECTOR_6",

  /**
   * Наличие напряжения на 3 фазе после АВР
   */
