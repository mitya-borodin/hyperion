...
11. Реализовать АПИ для изменения состояния Макроса 👷‍♂️ ( Дима )
12. Доработать АПИ добавления макроса, добавив проверку на одинаковые settings ( Дима )
13. Реализовать витрину макросов ( Настя )
14. Реализовать Страницу сетапа для каждого типа Макросов ( Настя )
15. Реализовать список запущенных Макросов ( Настя )
16. Реализовать страницу работы с Макросом, для каждого макроса своя страница ( Настя )
