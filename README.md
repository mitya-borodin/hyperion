...
1. Умный дом — это система автоматизации домашних устройств, которая позволяет управлять ими удалённо или с помощью голосовых команд. Она может включать в себя освещение, климат-контроль, безопасность и другие функции для повышения комфорта и эффективности использования ресурсов.

2. Домашняя автоматизация — это процесс внедрения технологий и систем, которые позволяют автоматизировать и контролировать различные аспекты домашнего хозяйства. Это включает в себя использование датчиков, контроллеров и других устройств для управления освещением, температурой, безопасностью и другими функциями дома.

3. Автоматизация инженерных систем — это применение технологий и оборудования для автоматического управления инженерными системами здания, такими как отопление, вентиляция, кондиционирование воздуха, освещение и т. д. Цель — повысить эффективность работы систем, снизить энергопотребление и обеспечить более комфортные условия проживания или работы.

4. Сценарий автоматизации — это заранее запрограммированная последовательность действий, которую могут выполнять устройства умного дома при определённых условиях. Например, сценарий «Утро» может автоматически включать свет, открывать шторы, включать музыку и готовить кофе к определённому времени. Сценарии помогают автоматизировать рутинные задачи и делают жизнь более удобной.

Вариант 2

1 управление функциями и вещами с помощью автоматики или полу автоматикой.
2 выполнение действий без вмешательства человека.
3 выполнение действий заданые оператором в инженерных системах ( газ свет Итд)
4 действие при каких-то заданных условий .

Вариант 3

Умный дом - это комплекс технологических мер, направленных на улучшение и упрощения проживания в доме, а также делающий проживание в доме более безопасным и экономным

Домашняя автоматизация - это совокупность электромеханических исполнительных механизмов и регулирующего органа, исключающее участие человека в ежедневных рутинных действиях, выполняемых в доме

Автоматизация инженерных систем - из той же оперы, только то, что касается отопления (регулировка температуры, включение - отключение, контроль и регулировка давления в системе), водоснабжения (температура, утечки, давление в зависимости от количества и расхода на потребителях), электроснабжения (ну тут сам)

Сценарий автоматизации - последовательность входящих (причина) и исходящих(следствие) сигналов, поступающих в регулирующий орган (контроллер), которые являются условиями срабатывания ИМ в той или иной бытовой ситуации
...
- Нет блокировки на производители специализированной автоматики для:
  ...
  - Так как автоматизация строится на уверсальных устроствах Wirenboard, и [Zigbee](https://www.zigbee2mqtt.io/supported-devices).
