...
Автоматизация инженерных систем без легаси навсегда.

## Преимущества

Все уприрается в вопрос цены, если цена за готовые, решения с теми же возможностями, что дает Hyperion вас устраивает, то смысл рассматривать использвоание Hyperion отсутствует.
...
- Увлажнение
  ...
  - Управление ( вкл/выкл ) однозоонной форсуночной системой увлажнения
...
- Открывашка
  ...
  - Управление замками
- Греющий кабель
  - Управление скрытым в стеме полотенце сушителем
