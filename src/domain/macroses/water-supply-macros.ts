...
//           'It is impossible to send a message because the device has 
// not been found, or the topic has not been defined 🚨',
//         );
//         logger(
//           stringify({
//             name: this.name,
