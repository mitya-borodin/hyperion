 ...
 *
 * TODO 4. Сделать реакцию на освещенность с задержкой по времени, если освещенность достигла
 * TODO     указанного порога и продержалась указанное кол-во минут, значит нужно выполнить действие.
 *
 * TODO 5. Сделать возможность задавать блокировку, от восхода солнца и до заката, от восхода и до заданного времени,
 * TODO     от времени и до восхода, от заката и до восхода, от заданного времени и до заката.
 */
